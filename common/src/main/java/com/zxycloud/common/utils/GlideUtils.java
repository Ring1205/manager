...
public class GlideUtils {
    ...
    //默认加载
    public void loadImageView(Context mContext, Uri path, ImageView mImageView) {
    ...
    //默认加载
    public void loadImageViewAsBitmap(Context mContext, String imgUrl, ImageView mImageView, boolean asBitmap) {
        if (asBitmap) {
    ...
    //设置监听请求接口
    public void loadImageViewListener(Context mContext, String path, ImageView mImageView, RequestListener<Drawable> requestListener) {
