...
import com.jzxfyun.manager.fragment.count.CountFragment;
import com.jzxfyun.manager.event.TabSelectedEvent;
import com.jzxfyun.manager.fragment.home.HomeFragment;
import com.jzxfyun.manager.fragment.mine.MineFragment;
...
public class MainFragment extends SupportFragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (firstFragment == null) {
            ...
            mFragments[SECOND] = CountFragment.newInstance();
            ...
            mFragments[SECOND] = findChildFragment(CountFragment.class);
    ...
    private void initView(View view) {
        ...
        mBottomBar
                .addItem(new BottomBarTab(_mActivity, R.mipmap.ic_discover_white_24dp, getString(R.string.home)))
                .addItem(new BottomBarTab(_mActivity, R.mipmap.ic_message_white_24dp, getString(R.string.count)))
                .addItem(new BottomBarTab(_mActivity, R.mipmap.ic_home_white_24dp, getString(R.string.service)))
                .addItem(new BottomBarTab(_mActivity, R.mipmap.ic_account_circle_white_24dp, getString(R.string.mine)));
