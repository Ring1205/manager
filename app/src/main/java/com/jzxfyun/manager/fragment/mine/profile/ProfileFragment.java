...
public class ProfileFragment extends BaseBackFragment {
    ...
    protected void initView() {
        ...
        // 设置点击事件
        setOnClickListener(R.id.edit_email, R.id.edit_phone, R.id.edit_birthday, R.id.edit_sex, R.id.edit_position, R.id.img_header);
                        ...
                        if (CommonUtils.judgeListNull(deniedPermission) == 0) {
                            ...
                            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                                ...
                                if (Build.VERSION.SDK_INT >= 24) {
                                    uri = FileProvider.getUriForFile(getContext().getApplicationContext(), "com.jzxfyun.manager.fileprovider", path);
                                } else {
